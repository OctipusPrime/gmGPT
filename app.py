...
parser = argparse.ArgumentParser(description='Adventure game command line interface')

# Add the arguments
parser.add_argument('command', choices=['continue', 'transfer', 'rebuild'], help='The command to run')
